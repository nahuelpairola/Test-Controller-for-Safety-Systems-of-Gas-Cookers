...
# 52 "C:/Program Files/Microchip/MPLABX/v5.50/packs/Microchip/PIC18F-K_DFP/1.4.87/xc8\pic\include\proc\pic18f25k80.h"
...
uint8_t DataReceived[15];
uint8_t DatatoSend[128];
bool channelToSend[8];
...
LATBbits.LATB4 = 0;
LATBbits.LATB5 = 0;
Data.conversionReady = 0;
Data.Bluetooth.ReceivingData = 0;
Data.Bluetooth.DatawasReceived = 0;
...
Data.SamplingWished = 0.1;
Data.counterSamplingWished = 1;

INSTRUMENT_enableTimer();

INSTRUMENT_enableADQcommunication();
ADS1115_config(0b10010010,0b11110101);
Data.Channel[CHANNEL_1].adc = ADS1115_read(0b10010010);
ADS1115_config(0b10010010,0b11100101);
Data.Channel[CHANNEL_2].adc = ADS1115_read(0b10010010);
ADS1115_config(0b10010010,0b11010101);
Data.Channel[CHANNEL_3].adc = ADS1115_read(0b10010010);
ADS1115_config(0b10010010,0b11000101);
Data.Channel[CHANNEL_4].adc = ADS1115_read(0b10010010);
ADS1115_config(0b10010000,0b11110101);
Data.Channel[CHANNEL_5].adc = ADS1115_read(0b10010000);
ADS1115_config(0b10010000,0b11100101);
Data.Channel[CHANNEL_6].adc = ADS1115_read(0b10010000);
ADS1115_config(0b10010000,0b11010101);
Data.Channel[CHANNEL_7].adc = ADS1115_read(0b10010000);
ADS1115_config(0b10010000,0b11000101);
Data.Channel[CHANNEL_8].adc = ADS1115_read(0b10010000);
}
...
case INSTRUMENT_ADQ_CHECK_AND_CONFIGURATION:
Data.ADQ1configurated = INSTRUMENT_configurationADQ(0b10010010,0b11000101);
Data.ADQ2configurated = INSTRUMENT_configurationADQ(0b10010000,0b11000101);
...
if(PORTCbits.RC5) {
Data.Bluetooth.Connected = 1;
LATBbits.LATB4 = 1;
Data.State = INSTRUMENT_BLUETOOTH_CHECK_IF_DATA_WAS_RECEIVED;
} else {
Data.Bluetooth.Connected = 0;
INSTRUMENT_Reset();
Data.State = INSTRUMENT_BLUETOOTH_CHECK_CONNECTION;
}
break;

case INSTRUMENT_BLUETOOTH_CHECK_IF_DATA_WAS_RECEIVED:
if(eusart1RxCount>0) {
...
Data.SamplingWished = 0.1;
Data.counterSamplingWished = 1;
LATAbits.LATA5 = 0; LATAbits.LATA3 = 0;
LATAbits.LATA2 = 0; LATAbits.LATA1 = 0;
LATAbits.LATA0 = 0; LATBbits.LATB3 = 0;
LATBbits.LATB2 = 0; LATBbits.LATB1 = 0;
}
break;
...
if(Data.readyToSend) {
Data.readyToSend = 0;
Data.Bluetooth.DataConcatenated = 0;
...
LATBbits.LATB4 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATBbits.LATB5 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATAbits.LATA5 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATAbits.LATA3 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATAbits.LATA2 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATAbits.LATA1 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATAbits.LATA0 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATBbits.LATB3 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATBbits.LATB2 = 1; _delay((unsigned long)((200)*(64000000/4000.0)));
LATBbits.LATB1 = 1; _delay((unsigned long)((500)*(64000000/4000.0)));
...
Data.Bluetooth.channelToSend[i] = 0;
}
for(int i = 0; i<15;++i) {
Data.Bluetooth.DataReceived[i] = '0';
}
...
switch(datareceived) {
case '*':
Data.Bluetooth.ReceivingData = 1;
break;
case ';':
Data.Bluetooth.ReceivingData = 0;
break;
...
Data.Bluetooth.channelToSend[CHANNEL_1] = 1;
LATAbits.LATA5 = 1;
Data.Channel[CHANNEL_1].voltage = 0.;
Data.Channel[CHANNEL_1].time = 0.;
}
break;
case 'B':
if(Data.Bluetooth.channelToSend[CHANNEL_1]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_1] = 0;
LATAbits.LATA5 = 0;
Data.Channel[CHANNEL_1].time = 0.;
Data.Channel[CHANNEL_1].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_2] = 1;
LATAbits.LATA3 = 1;
Data.Channel[CHANNEL_2].time = 0.;
Data.Channel[CHANNEL_2].voltage = 0.;
}
break;
case 'D':
if(Data.Bluetooth.channelToSend[CHANNEL_2]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_2] = 0;
LATAbits.LATA3 = 0;
Data.Channel[CHANNEL_2].time = 0.;
Data.Channel[CHANNEL_2].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_3] = 1;
LATAbits.LATA2 = 1;
Data.Channel[CHANNEL_3].time = 0.;
Data.Channel[CHANNEL_3].voltage = 0.;
}
break;
case 'F':
if(Data.Bluetooth.channelToSend[CHANNEL_3]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_3] = 0;
LATAbits.LATA2 = 0;
Data.Channel[CHANNEL_3].time = 0.;
Data.Channel[CHANNEL_3].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_4] = 1;
LATAbits.LATA1 = 1;
Data.Channel[CHANNEL_4].time = 0.;
Data.Channel[CHANNEL_4].voltage = 0.;
}
break;
case 'H':
if(Data.Bluetooth.channelToSend[CHANNEL_4]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_4] = 0;
LATAbits.LATA1 = 0;
Data.Channel[CHANNEL_4].time = 0.;
Data.Channel[CHANNEL_4].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_5] = 1;
LATAbits.LATA0 = 1;
Data.Channel[CHANNEL_5].time = 0.;
Data.Channel[CHANNEL_5].voltage = 0.;
}
break;
case 'J':
if(Data.Bluetooth.channelToSend[CHANNEL_5]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_5] = 0;
LATAbits.LATA0 = 0;
Data.Channel[CHANNEL_5].time = 0.;
Data.Channel[CHANNEL_5].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_6] = 1;
LATBbits.LATB3 = 1;
Data.Channel[CHANNEL_6].time = 0.;
Data.Channel[CHANNEL_6].voltage = 0.;
}
break;
case 'L':
if(Data.Bluetooth.channelToSend[CHANNEL_6]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_6] = 0;
LATBbits.LATB3 = 0;
Data.Channel[CHANNEL_6].time = 0.;
Data.Channel[CHANNEL_6].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_7] = 1;
LATBbits.LATB2 = 1;
Data.Channel[CHANNEL_7].time = 0.;
Data.Channel[CHANNEL_7].voltage = 0.;
}
break;
case 'N':
if(Data.Bluetooth.channelToSend[CHANNEL_7]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_7] = 0;
LATBbits.LATB2 = 0;
Data.Channel[CHANNEL_7].time = 0.;
Data.Channel[CHANNEL_7].voltage = 0.;
}
...
Data.Bluetooth.channelToSend[CHANNEL_8] = 1;
LATBbits.LATB1 = 1;
Data.Channel[CHANNEL_8].time = 0.;
Data.Channel[CHANNEL_8].voltage = 0.;
}
break;
case 'P':
if(Data.Bluetooth.channelToSend[CHANNEL_8]&&Data.Bluetooth.ReceivingData) {
Data.Bluetooth.channelToSend[CHANNEL_8] = 0;
LATBbits.LATB1 = 0;
Data.Channel[CHANNEL_8].time = 0.;
Data.Channel[CHANNEL_8].voltage = 0.;
}
...
case 'R':
if(Data.Bluetooth.ReceivingData){
Data.SamplingWished = 0.5;
Data.counterSamplingWished = 5;
}
break;
case 'S':
if(Data.Bluetooth.ReceivingData){
Data.SamplingWished = 0.2;
Data.counterSamplingWished = 2;
}
break;
case 'T':
if(Data.Bluetooth.ReceivingData){
Data.SamplingWished = 1.0;
Data.counterSamplingWished = 10;
}
break;
default:
break;
